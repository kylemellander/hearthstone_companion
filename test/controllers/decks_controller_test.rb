...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { name: @deck.name, player_class: @deck.player_class, remote_id: @deck.remote_id, url: @deck.url }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { name: @deck.name, player_class: @deck.player_class, remote_id: @deck.remote_id, url: @deck.url }
    assert_redirected_to deck_path(assigns(:deck))
  end
