...
export default Ember.Component.extend({
  ...
  actions: {
    ...
    setCardSet(str) {
      var names = {"": "All", "Classic": "Classic", "Naxxramas": "Naxx", "Promotion": "Promo", "Goblins vs Gnomes": "GVG", "Blackrock Mountain": "BRM", "The Grand Tournament": "TGT", "The League of Explorers": "LOE"};
